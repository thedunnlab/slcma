...
```
## Warning: package 'selectiveInference' was built under R version 4.2.3
```
...
```
## Warning: package 'intervals' was built under R version 4.2.3
```
...
```
## Warning: package 'adaptMCMC' was built under R version 4.2.3
```
...
##     2                       x1                          2     0.028
##     3     Mobility(x2, x3)down                          3     0.040
##     4                       x3                          4     0.040
##     5       Mobility(x1, x2)up                          5     0.041
##     6                                        x3         4     0.042
...
## R-squared from lasso fit: 0.040
## 
## Results from fixed lasso inference (selective inference):
## 
## Standard deviation of noise (specified or estimated) sigma = 5.135
## 
## Testing results at lambda = 5.553, with alpha = 0.050
## 
##                            Coef P-value  CI.lo  CI.up LoTailArea UpTailArea
## x1                       -0.778   0.148 -1.689  0.796      0.024      0.024
## Accumulation(x1, x2, x3) -0.608   0.009 -1.220 -0.114      0.025      0.024
## Mobility(x2, x3)down      1.196   0.045 -0.228  2.177      0.025      0.024
```
...
## 
## R-squared from relaxed lasso fit: 0.042
## 
##                                Coef        SE      CI.lo      CI.up
## x1                       -0.7781529 0.4554670 -1.6708518  0.1145461
## Accumulation(x1, x2, x3) -0.6082188 0.2274878 -1.0540867 -0.1623509
## Mobility(x2, x3)down      1.1962127 0.4967755  0.2225506  2.1698749
```
...
## 
## Error standard deviation: 5.128 on 1082 degrees of freedom
## 
##                                Coef      P-value
## Accumulation(x1, x2, x3) -0.9641575 2.701154e-09
## 
## Message regarding calculation of P-value: Normal Completion
##  with estimated numeric absolute error: 1.232953e-09
```
...
## Accumulation(x1, x2, x3) -0.9641575 2.701154e-09 -1.30898 -0.6461124
## 
## Message regarding calculation of P-value: Normal Completion
##  with estimated numeric absolute error: 1.232953e-09
```
...
## x2                       0.00000028
## x3                       0.00192777
## Accumulation(x1, x2, x3) 0.98548478
## Mobility(x1, x2)up       0.00000018
## Mobility(x1, x2)down     0.00000000
## Mobility(x2, x3)up       0.00000000
## Mobility(x2, x3)down     0.00000153
```
...
## 
##                            Coef P-value  CI.lo  CI.up LoTailArea UpTailArea
## Accumulation(x1, x2, x3) -0.964       0 -1.266 -0.637      0.025      0.024
## 
## Results from max-|t| test:
## 
## Error standard deviation: 5.128 on 1082 degrees of freedom
...
## Results from relaxed lasso:
## 
## R-squared from relaxed lasso fit: 0.035
## 
##                                Coef        SE     CI.lo      CI.up
## Accumulation(x1, x2, x3) -0.9641575 0.1539688 -1.265931 -0.6623842
## 
## Posterior probabilities:
##                                    
## x1                       0.01258545
